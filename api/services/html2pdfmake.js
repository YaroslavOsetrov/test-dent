...
var html2pdfmake =function(html){
    ...
    function ParseElement(cnt, e, p, styles){
        ...
        switch (e.nodeName.toLowerCase()) {
            ...
            case 'h1':
                ...
                st.stack.push(p);
                ComputeStyle(st, styles);
                ParseContainer(st.stack, e, p, styles.concat(['font-weight:bold']).concat(['font-size:18']));
                cnt.push(st);
                break;
            case 'h2':
            case 'h3':
                ...
                st.stack.push(p);
                ComputeStyle(st, styles);
                ParseContainer(st.stack, e, p, styles.concat(['font-weight:bold']).concat(['font-size:14']));
                cnt.push(st);
                break;
            case 'ul':
                 var ul = {ul: []};
    ...
    function ParseHtml(cnt, htmlText){
      ...
      $('<div>').html(htmlText).contents().each((index, content) => {
