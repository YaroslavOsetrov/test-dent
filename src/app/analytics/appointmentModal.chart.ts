...
@Component({
    ...
    templateUrl: 'appointmentModal.chart.html',
    exportAs:'appointmentModal'
})
export class AppointmentModalComponent implements OnInit {
    ...
    show(interval, userId){
        ...
        this.analyticsService.getStats(interval.start, interval.end, 'appointmentsList', userId).subscribe(
            response => {
